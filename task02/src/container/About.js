          ...
          <div className="inner topic">
            <div className="topic_content">
              <div className="markdown-text">
                ...
                <p>
                  客户端由{" "}
                  <a href="https://cnodejs.org/user/soliury">@soliury</a>{" "}
                  开发维护。
                </p>
                <p>
                  源码地址：{" "}
              ...
              <div className="about-friend-links">
                ...
                <a href="http://yunzhihui.com/">
                  <img
                    alt=""
                    src="//static.cnodejs.org/Fq2cV_14IFHwelZ-6jey42Z0-eOR"
                  />
                </a>

                <a href="http://www.jiguang.cn/">
                  <img
                    alt=""
                    src="//static.cnodejs.org/FijGJbij9GObh5AXw-Vyu5LGn08a"
                  />
                </a>
